...
def handler(self: "PrimeBDS", sender: CommandSender, args: list[str]) -> bool:
    ...
    if not is_gl_enabled and sender.name not in gl_notice:
        sender.send_message("New grief logs are not being recorded as it is §cDisabled §rin the config")
        sender.send_message("Use §e/primebds config §rif you wish to change this")
        gl_notice.add(sender.name)
